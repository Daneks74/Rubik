...
class DailyPitcherProjection(Base):
    ...
    k_p20 = Column(Float, nullable=True)
    k_p50 = Column(Float, nullable=True)
    k_p80 = Column(Float, nullable=True)
    era_p20 = Column(Float, nullable=True)
    era_p50 = Column(Float, nullable=True)
    era_p80 = Column(Float, nullable=True)
    whip_p20 = Column(Float, nullable=True)
    whip_p50 = Column(Float, nullable=True)
    whip_p80 = Column(Float, nullable=True)
